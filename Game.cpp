...
void declareWinner(Pokemon & x)
{
    if(x.getSideStatus() == false ) // The enemy's health has been returned, ergo the enemy is the loser
    {
        std::cout << "The enemy has 0 health left! You win!! \n\n";
    }


    else if(x.getSideStatus() == true) //The player's health has been returned, ergo the player is the loser
    {
